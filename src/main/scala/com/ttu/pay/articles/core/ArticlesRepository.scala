...
class ArticlesRepository(quill: Quill.Postgres[Literal]):
  import quill.*
...
object ArticlesRepository:
  val live: ZLayer[Quill.Postgres[Literal], Nothing, ArticlesRepository] =

...
import com.ttu.pay.common.Exceptions
import com.ttu.pay.common.domain.Username
import com.ttu.pay.users.api.{UserRegisterData, UserUpdateData}
import io.getquill.*
...
class UsersRepository(quill: Quill.Postgres[Literal]):
  import quill.*
...
object UsersRepository:
  val live: ZLayer[Quill.Postgres[Literal], Nothing, UsersRepository] =
